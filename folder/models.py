...
class Folder(models.Model):
    ...
    direct_tag_set          = models.ManyToManyField(Tag, related_name='direct_tag_set')
    # which tags a user needs to access this folder (e.g. subtrees)
    # field make for fast permission lookup
    indirect_tag_set = models.ManyToManyField(Tag, related_name='indirect_tag_set')
