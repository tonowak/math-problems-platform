"""
Django settings for math_problems_platform project.
...
ROOT_URLCONF = 'math_problems_platform.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            'math_problems_platform/templates',
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'math_problems_platform.wsgi.application'
